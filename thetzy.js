...
global.youtube = 'https://youtube.com/ShinoaHiiragi'
global.ig = 'https://instagram.com/boedzhanks'
global.mygc = 'https://chat.whatsapp.com/HOgPgwQjl98KN3CGL1qa9C'
global.myweb = 'https://saweria.co/shinoahiiragicrack'
global.linkgrupss = "https://chat.whatsapp.com/HOgPgwQjl98KN3CGL1qa9C"
...
global.email = 'boedzhankss@gmail.com'
...
//—————「 Set Nama Own & Bot 」—————//
global.nomerOwner = "6283129109022" //Bebas ganti 
global.namaOwner = "Boedzhanks" //Bebas ganti
global.footer = '©Boedzhanks' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.packname = ''
global.ownerr = ['Boedzhanks']
global.author = 'Shinoa~Bot'
global.prefa = ['','!','.',',','#','*']
global.sp = '⭔'
global.mess = {
    wait: '⏳ _*Loading...*_',
...
//=================================================//
global.thumb = { url: 'https://telegra.ph/file/1f4e3f6b35377765a5f32.jpg' }
global.visoka = { url: 'https://a.uguu.se/fVFNCwix.mp4' }
global.menuimg = { url: 'https://telegra.ph/file/1f4e3f6b35377765a5f32.jpg' }
global.zy = { url: 'https://telegra.ph/file/1f4e3f6b35377765a5f32.jpg' }
global.logonya = fs.readFileSync("./media/gambarnye/thezyren.jpg")
global.thumbnailvid = { url: 'https://telegra.ph/file/1f4e3f6b35377765a5f32.jpg' }
